...
const PropertyCalendarPage = () => {
  ...
  // Property data with iCal URLs, pricing, and images
  const propertyData: { [key: string]: { title: string; icalUrls: string[]; pricePerNight: number; images: string[] } } = {
    "bijou-bamboo": {
      title: "Bijou Bamboo",
      pricePerNight: 2500000,
      icalUrls: [
        "https://www.airbnb.com/calendar/ical/866272882264783204.ics?s=fa9fed7f00c434b1a0284c0f1bc6f636"
      ],
      images: [
    ...
    "villa-kupu-kupu": {
      ...
      icalUrls: [
        "https://www.airbnb.com.sg/calendar/ical/1378150393289547131.ics?s=9d91315103cadf417832e08e914a0773"
      ],
      images: [
    ...
    "casa-catania": {
      ...
      icalUrls: [
        "https://www.airbnb.com/calendar/ical/1436647094938756179.ics?s=0b39b4702756f20617a10b01ffa245dc"
      ],
      images: [
    ...
    "villa-c3": {
      ...
      pricePerNight: 1700000,
      icalUrls: [
        "https://www.airbnb.com.sg/calendar/ical/1472919734742295245.ics?s=2afeff9f56c51ed784b8c752dbf6c781"
      ],
      images: [
    ...
    "villa-serenity": {
      ...
      pricePerNight: 1700000,
      icalUrls: [
        "https://www.airbnb.com.sg/calendar/ical/1040984217790320907.ics?s=9348f9a5fe1fa8b13c76b2da6e505169"
      ],
      images: [
    ...
    "casa-bubu": {
      ...
      icalUrls: [
        "https://www.airbnb.com.sg/calendar/ical/867775235745142488.ics?s=214c9f2dcb90b000379829f78b69ded9"
      ],
      images: [
    ...
    "queen-villa": {
      ...
      icalUrls: [
        "https://www.airbnb.com/calendar/ical/placeholder.ics" // Placeholder for fully open availability
      ],
      images: [
    ...
    "casa-baba": {
      ...
      pricePerNight: 1700000,
      icalUrls: [
        "https://www.airbnb.com.sg/calendar/ical/1338090928360657679.ics?s=1bec8c0e8eeeef00af700b0fa51d0db5"
      ],
      images: [
      ...
      <div className="container mx-auto px-6 py-20">
        <div className="text-center">
          ...
          <button 
            ...
            className="bg-gradient-sunset text-white px-6 py-2 rounded-lg"
          >
            Back to Properties
          </button>
        </div>
  ...
  if (!property.icalUrls.length) {
    return (
      <div className="container mx-auto px-6 py-20">
        <div className="text-center">
          <h1 className="text-2xl font-bold mb-4">Calendar Not Available</h1>
          <p className="mb-4 text-muted-foreground">
            Calendar availability for {property.title} is not yet configured.
          </p>
          <button 
            onClick={() => navigate("/rentals")}
            className="bg-gradient-sunset text-white px-6 py-2 rounded-lg"
